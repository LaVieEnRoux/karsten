...
from nan_AboveSurf import nan_AboveSurf
from EnsembleData_FlowFile import EnsembleData_FlowFile
import seaborn
...
#                           data.saveparams, data.options)
    ...
    t_ens = 600 # ten minutes
    time_ens, data_ens, pres_ens = EnsembleData_FlowFile(t_ens, time, data,
							 pres)
    
    out_struct = {'time':time_ens, 'data':data_ens, 'pres':pres_ens}
    sio.savemat('test_processed_ADCP.mat', out_struct)
